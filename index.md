...
So, across the decade you’re effectively seeing a **phase transition**:
• Wealth based on controlling *resources* (energy) →
• Wealth based on controlling *distribution to masses* (biomass) →
• Wealth based on controlling *information and computation* (networks).
